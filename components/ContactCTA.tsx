...
export default function ContactCTA() {
  ...
  return (
    <section id="contact" className="bg-brand-blue py-16 text-white sm:py-24">
      <div className="container-page">
        <StaggerContainer stagger={0.1} amount={0.3} className="text-center">
          <StaggerItem>
          ...
          <StaggerItem>
            <div className="mx-auto mt-8 flex max-w-md flex-col items-stretch gap-3">
              <ContactLink
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-brand-green px-5 text-base font-semibold text-white shadow-sm transition-colors hover:bg-brand-green/90 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-brand-blue"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-white/30 bg-white/10 px-5 text-base font-semibold text-white shadow-sm transition-colors hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-brand-blue"
              >
